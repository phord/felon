...
mod filtered_log_iterator_tests {
    ...
    fn test_iterator_gaps() {
        let (harness, mut file) = Harness::default();
        assert!(file.filter_regex(r"0$").is_ok());
